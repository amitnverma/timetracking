-- Import this in Hostinger phpMyAdmin AFTER selecting your database.
-- Do NOT run CREATE DATABASE here — use the DB name Hostinger gave you
-- (often like u123456789_timetracking), then Import this file.
-- Safe to re-run (IF NOT EXISTS / seed guards).
